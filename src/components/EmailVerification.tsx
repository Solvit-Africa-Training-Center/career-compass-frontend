          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="flex justify-center mt-6">
              <InputOTP
                ...
                className="gap-2 md:gap-3 w-full max-w-xs"
              >
                <InputOTPGroup className="gap-2">
                  <InputOTPSlot
                    index={0}
                    className="w-8 h-10 md:w-12 md:h-12 text-lg md:text-xl font-semibold"
                  />
                  <InputOTPSlot
                    index={1}
                    className="w-8 h-10 md:w-12 md:h-12 text-lg md:text-xl font-semibold"
                ...
                <InputOTPGroup className="gap-2">
                  ...
                  <InputOTPSlot
                    index={5}
                    className="w-2 h-10 md:w-12 md:h-12 text-lg md:text-xl font-semibold"
                  />
                </InputOTPGroup>
              </InputOTP>
            </div>
